...
export class ConnectionPool {
  ...
  constructor(options: {
    ...
    this.maxPoolSize = options.maxPoolSize || 100; // 增加到100个连接
    this.healthCheckInterval = options.healthCheckInterval || 60000; // 60秒健康检查
    this.heartbeatTimeout = options.heartbeatTimeout || 75000; // 75秒超时匹配heartbeat
...
export const connectionPool = new ConnectionPool({
  maxPoolSize: 100, // 增加到100个连接
  healthCheckInterval: 60000, // 60秒健康检查
  heartbeatTimeout: 75000, // 75秒超时匹配heartbeat
}); 